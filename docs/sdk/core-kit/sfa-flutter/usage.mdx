...
sidebar_label: "Usage"
displayed_sidebar: sdk_core_kit_sfa_flutter
...
choose to use any
[social](/auth-provider-setup/social-providers/)/[federated identity](/auth-provider-setup/authentication-service-providers)
